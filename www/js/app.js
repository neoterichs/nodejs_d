...
var token = "";
angular.module('ionicApp', ['ionic','ngCordova','ionic.contrib.frostedGlass','starter.controllers'])
...
.service('CalcService', function($rootScope,$ionicPopup,$cordovaLocalNotification){
	...
	this.connect = function() { 
		...
		socket.onmessage = function(e) {
			...
			if(x[0].socketname == "new_chat_message"){
				console.log("d");
				var userid = localStorage.getItem("userid");
				if(userid != x[0].fromid)
				$rootScope.$broadcast('newchatm',{message:x[0].message});
			}
